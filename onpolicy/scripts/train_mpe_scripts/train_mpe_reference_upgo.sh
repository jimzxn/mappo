...
do
    ...
    --ppo_epoch 15 --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --use_gae false --wandb_name "mappo" --user_name "jimzhao0422" --share_policy
done
for seed in `seq ${seed_max}`;
do
    echo "seed is ${seed}:"
    ...
    --scenario_name ${scenario} --num_agents ${num_agents} --num_landmarks ${num_landmarks} --seed ${seed} \
    --n_training_threads 1 --n_rollout_threads 128 --num_mini_batch 1 --episode_length 25 --num_env_steps 4000000 \
    --ppo_epoch 15 --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --wandb_name "mappo" --user_name "jimzhao0422" --share_policy
done